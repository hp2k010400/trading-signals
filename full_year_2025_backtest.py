"""
full_year_2025_backtest.py

Full calendar year 2025 backtest (2025-01-01 -> 2026-01-01), using the
exact same locked, validated logic as the live EA (0.10% displacement,
...
Run in Codespace: python -u full_year_2025_backtest.py
"""
import pandas as pd
import numpy as np
import os, warnings
...
MAX_HOLD_MIN = 240
YTD_START = pd.Timestamp('2025-01-01', tz='UTC')
YTD_END   = pd.Timestamp('2026-01-01', tz='UTC')
...
print(f'{"="*80}')
print(f'  FULL CALENDAR YEAR 2025 (2025-01-01 -> 2025-12-31)')
print(f'{"="*80}')
...
print(f'\n  Total 2025 £ (months summed independently): £{monthly["pnl_gbp"].sum():>+,.0f}')
